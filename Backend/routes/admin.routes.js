...
router.get(
    ...
    adminMiddileware.authAdmin,
    adminController.getAllReviewerAssignments,
);
router.post(
    "/research-proposal/approval-budget",
    adminMiddileware.authAdmin,
    adminController.updateApprovalBudget,
);
router.post(
    "/research-proposal/request-reset-password",
    adminController.requestPasswordReset,
);
router.post("/research-proposal/reset-password", adminController.resetPassword);
router.post(
    "/research-proposal/sent-to-reviewer",
    adminMiddileware.authAdmin,
    adminController.sentToReviewer,
);
router.post(
    "/research-proposal/fiscal-year/update",
    adminMiddileware.authAdmin,
    adminController.updateFiscalYear,
);
router.put(
    "/research-proposal/registration-status/update/:value",
    adminMiddileware.authAdmin,
    adminController.updateRegistrationOpen,
);
router.post(
    "/reviewer/add",
    adminMiddileware.authAdmin,
...
router.post(
    "/research-proposal/reviewer/remove",
    adminMiddileware.authAdmin,
    adminController.deleteReviewerAssignment,
);
router.put(
    "/reviewer/update/:id",
    adminMiddileware.authAdmin,
    adminController.updateReviewer,
);
router.delete(
    "/reviewer/delete/:id",
    adminMiddileware.authAdmin,
    adminController.deleteReviewer,
);
router.get(
    "/reviewer/:id",
    adminMiddileware.authAdmin,
...
router.get(
    "/research-proposal/overviews",
    adminController.getProposalOverviews,
);
router.put(
    "/research-proposal/status-update/:proposal_type/:proposal_id/:status",
    adminMiddileware.authAdmin,
