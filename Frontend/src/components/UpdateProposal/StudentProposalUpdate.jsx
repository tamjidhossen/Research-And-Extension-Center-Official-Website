...
export default function StudentProposalUpdate() {
        ...
        if (response.data.success) {
          ...
          if (response.data.proposal.proposal_type === "student") {
            ...
            form.reset({
              ...
              roll_no: proposal.roll_no || "",
              cgpa_honours: proposal.cgpa_honours?.toString() || "",
              supervisor_name: proposal.supervisor.name || "",
              supervisor_designation: proposal.supervisor.designation || "",
              supervisor_department: proposal.supervisor.department || "",
              supervisor_faculty: proposal.supervisor.faculty || "",
            ...
            toast({
              ...
              description: "This update link is not for a student proposal",
              variant: "destructive",
            });
          }
        } else {
  ...
  const onSubmit = async (data) => {
    ...
    const updatesObj = {
      ...
      cgpa_honours: parseFloat(data.cgpa_honours),
      supervisor: {
      ...
      project_details: {
        approx_pages: parseInt(data.approx_pages) || 0,
        approx_words: parseInt(data.approx_words) || 0,
      },
      total_budget: parseInt(data.total_budget) || 0,
    ...
    try {
      ...
      const response = await api.post(
        "/api/research-proposal/student/update",
        formData,
        {
          headers: {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-emerald-800 dark:text-emerald-400 mb-2">
            Update Student Research Proposal
          </h1>
