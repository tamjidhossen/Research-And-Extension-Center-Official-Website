...
const dummyNotices = [
  ...
  },
  {
    ...
    description: "A three-day workshop on Research Methodology will be held from March 15-17, 2024. The workshop will cover qualitative and quantitative research methods, research design, data collection techniques, and analysis using SPSS and other statistical tools.\n\nVenue: Conference Hall, Admin Building\nTime: 10:00 AM - 4:00 PM",
  ...
  },
  {
    ...
    description: "The results of the Student Research Grant 2023 have been published. A total of 15 student projects were selected for funding. Congratulations to all successful applicants! The first installment of funding will be disbursed by March 10, 2024. Selected students are requested to submit their acceptance forms by March 5, 2024.",
  ...
  },
  {
    ...
    description: "Due to numerous requests, the deadline for submitting faculty research proposals has been extended to April 15, 2024. Please ensure that all proposals follow the updated guidelines available on the REC website.",
  ...
  },
  {
    ...
    description: "The Research and Extension Center has updated its journal publication guidelines. All researchers are requested to follow the new citation style and formatting requirements for submissions to the JKKNIU Journal of Research.\n\nThe new guidelines will take effect from March 1, 2024.",
  ...
  },
  {
    ...
    description: "Mark your calendars! The Annual Research Day will be held on April 20, 2024. Faculty members and students who have completed research projects in the past year are invited to present their findings. Poster presentations and oral presentations will be featured.\n\nAbstract submission deadline: March 25, 2024",
  ...
  if (loading) {
    return (
      <div className="min-h-[50vh] flex flex-col items-center justify-center">
        ...
        <p className="text-emerald-700 dark:text-emerald-300">Loading notices...</p>
      </div>
    );
  }
    ...
    <div className="container mx-auto max-w-4xl px-4 py-8 md:py-12">
      ...
      <div className="text-center mb-12">
        ...
        <p className="mt-4 text-gray-600 dark:text-gray-300">
          Stay updated with the latest news and announcements from JKKNIU Research and Extension Center
        </p>
              ...
              >
                <CardHeader className="relative space-y-4 pb-2">
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <Badge 
                      className={`bg-${categoryColor}-50 text-${categoryColor}-700 hover:bg-${categoryColor}-100 dark:bg-${categoryColor}-900/30 dark:text-${categoryColor}-400 dark:hover:bg-${categoryColor}-900/40 border-${categoryColor}-200 dark:border-${categoryColor}-800/50`}
                    >
                      {notice.category}
                    </Badge>
                    
                    {notice.hasAttachment && (
                      <Badge variant="outline" className="bg-transparent border-gray-200 dark:border-gray-800 text-gray-600 dark:text-gray-300 flex items-center gap-1">
                ...
                {notice.link && (
                  <CardContent className="pt-0">
                    <Button
                      ...
                      size="sm"
                      asChild
                      className="border-emerald-200 dark:border-emerald-800 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 hover:text-emerald-700 dark:hover:text-emerald-400 transition-all duration-300"
                    >
                      {notice.hasAttachment ? (
                        <a
                          href={notice.link}
